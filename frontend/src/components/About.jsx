  ...
  return (
    <div className='flex justify-center'>
        <div className="about-content w-1/2 flex flex-col justify-between">
          ...
          <button className='bg-transparent border border-orange-400 text-orange-500 w-40 h-12 text-md font-bold rounded-md'>Visit Us</button>
        </div>
