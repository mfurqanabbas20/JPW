    ...
    <div className='flex items-center w-full justify-between px-10 max-sm:w-full max-sm:justify-center '>
        ...
        <div className="nav-items text-md max-sm:hidden">
            <ul className='flex gap-6 cursor-pointer'>
                <Link className='hover:bg-blue-200 rounded-sm p-3' to='/home'>Home</Link>
                <Link className='hover:bg-blue-200 rounded-sm p-3' to='/home'>About Us</Link>
                <Link className='hover:bg-blue-200 rounded-sm p-3' to='/all-products'>Products</Link>
                <Link className='hover:bg-blue-200 rounded-sm p-3' to='/home'>Services</Link>
                <Link className='hover:bg-blue-200 rounded-sm p-3' to='/home'>Contact Us</Link>
            </ul>
        </div>
